...
const EmailVerificationFlow = () => {
  ...
  const renderMethodSelection = () => (
    <>
      {/* Title */}
      <div className='mb-2 flex flex-col text-center items-center px-4 sm:px-0'>
        <h2 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-black mb-2 sm:mb-4 leading-tight'>
          Verify Your Email Address
        </h2>
        <p className='text-black text-sm sm:text-base lg:text-lg px-2 sm:px-0'>
          Select your preferred means of verifying your email address
        </p>
      </div>

      {/* Method Selection */}
      <div className='flex flex-col sm:flex-row gap-4 sm:gap-6 w-full max-w-lg px-4 sm:px-0'>
        {/* OTP Option */}
        <div
          onClick={() => handleMethodSelect('otp')}
          className={`flex-1 p-4 sm:p-6 border-2 rounded-xl cursor-pointer transition-all duration-200 hover:shadow-lg ${
            selectedMethod === 'otp'
        ...
        >
          <div className='flex flex-col items-center text-center space-y-2 sm:space-y-3'>
            <div className='w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center'>
              <Image
                src='/assets/images/magic-link-image.png'
                alt='mail'
                width={50}
                height={50}
                className='w-full h-full'
      ...
      <button
        ...
        className='w-full max-w-sm mx-4 sm:mx-0 sm:max-w-md py-3 sm:py-4 bg-gradient-to-r from-[#F97316] to-[#EC4899] text-white font-bold rounded-xl transition-all duration-200 hover:from-orange-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base'
      >
        Continue
      </button>
    </>
  ...
  const renderOtpInput = () => (
    <>
      ...
      <form
        ...
        className='flex flex-col items-center space-y-6 sm:space-y-8 w-full px-4 sm:px-0'
      >
        {/* OTP Input Fields */}
        ...
        <button
          ...
          className='w-full max-w-sm sm:max-w-md py-3 sm:py-4 bg-gradient-to-r from-[#F97316] to-[#EC4899] text-white font-bold rounded-xl transition-all duration-200 hover:from-orange-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base'
        >
          {isLoading ? (
  ...
  const renderMagicLinkSent = () => (
    <>
      ...
      {/* Title and Message */}
      <div className='mb-2 flex flex-col text-center items-center max-w-lg px-4 sm:px-0'>
        <h2 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-black mb-2 sm:mb-4 leading-tight'>
          Verify Your Email Address
        </h2>
        <p className='text-black text-sm sm:text-base lg:text-lg mb-4 sm:mb-6 px-2 sm:px-0'>
      ...
      {canResend && (
        <button
          ...
          className='w-full max-w-sm mx-4 sm:mx-0 sm:max-w-md py-3 sm:py-4 bg-gradient-to-r from-[#F97316] to-[#EC4899] text-white font-bold rounded-xl transition-all duration-200 hover:from-orange-600 hover:to-pink-600 text-sm sm:text-base'
        >
          Resend Magic Link
        </button>
      )}
