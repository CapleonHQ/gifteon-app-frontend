        ...
        <div className='text-center max-w-lg mx-auto relative z-10'>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className='mb-8'>
              <motion.h1
                className='text-8xl sm:text-9xl lg:text-[12rem] font-bold bg-gradient-to-r from-[#EA580C] via-[#DB2777] to-[#9333EA] bg-clip-text text-transparent leading-none'
                animate={{
                  scale: [1, 1.02, 1],
                }}
                transition={{
            ...
            >
              <motion.button
                className='bg-gradient-to-r from-[#F97316] via-[#F25C5B] to-[#EC4899] text-white px-6 py-3 rounded-xl font-semibold flex items-center space-x-2 shadow-lg hover:shadow-xl transition-all duration-200'
